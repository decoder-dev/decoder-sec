...
//  DecoderSec
//
//  decoder sec. brand tokens — premium OLED black + neon green.
//
...
struct NeonGlow: ViewModifier {
    ...
    func body(content: Content) -> some View {
        content
            ...
            .shadow(color: Brand.Color.neon.opacity(opacity * 0.45), radius: radius * 2.2, x: 0, y: 0)
    }
}

extension View {
    func neonGlow(radius: CGFloat = 16, opacity: Double = 0.55) -> some View {
