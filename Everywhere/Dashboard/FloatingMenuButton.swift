            ...
            Menu {
                ...
                if #available(iOS 26.0, *) {
                    Image(systemName: "ellipsis")
                        ...
                        .background(
                            Circle()
                                .fill(Brand.Color.surface.opacity(0.92))
                                .overlay(Circle().stroke(Brand.Color.neon.opacity(0.35), lineWidth: 1))
                        )
                        .neonGlow(radius: 10, opacity: 0.35)
                        .contentShape(Circle())
                    ...
                    Image(systemName: "ellipsis")
                        ...
                        .background(
                            Circle()
                                .fill(Brand.Color.surface.opacity(0.92))
                                .overlay(Circle().stroke(Brand.Color.hairline, lineWidth: 1))
                        )
                        .contentShape(Circle())
                        .accessibilityLabel("More")
                }
